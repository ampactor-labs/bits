...
function events(catW: number, catH: number): RecipeEvent[] {
  ...
  return [
    ...
    { kind: 'WIRE', id: id(), at: 0, puppetId: '', source: 'on', target: 'foley', amount: 1 },
    {
      kind: 'CAST',
      id: id(),
      at: 0,
      puppetId: 'title',
      puppet: { type: 'text', text: 'how to bits', w: 0.6, h: 0.09 },
      x: 0.5,
      y: 0.09,
      scale: 1,
      rot: -0.03,
    },
    { kind: 'SOUND', id: id(), at: 5.55, puppetId: '', sfx: 'honk' },
    { kind: 'SOUND', id: id(), at: 10.2, puppetId: '', sfx: 'drop' },
    { kind: 'SOUND', id: id(), at: 11.3, puppetId: '', sfx: 'boing' },
